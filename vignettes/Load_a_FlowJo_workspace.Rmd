...
Within the `cyCONDOR` ecosystem it is possible to load a FlowJo work space (.wsp file). This gives the advantage of having the gating hierarchy in the `fcd` object.
...
```{r}
ws <- CytoML::open_flowjo_xml("../../data/.test_files/flowjo_workspace.wsp")
...
```{r}
gs <- CytoML::flowjo_to_gatingset(ws, name = "samples", path = "../../data/.test_files/fcs_flowjo_ws/")
