...
```{r}
condor <- prep_fcd(data_path = "../../../../2_data/paper_figures/Figure 3 - Batch Correction/data/CureDem/all/",
                   max_cell = 500,
                   useCSV = FALSE,
                   transformation = "auto_logi",
                   remove_param = c("Time", "FSC-H", "SSC-H"),
                   anno_table = "../../../../2_data/paper_figures/Figure 3 - Batch Correction/data/CureDem/all.csv",
