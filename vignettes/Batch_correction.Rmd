...
#load functions 
source("../../cyCONDOR/R/batch_correction.R")
source("../../cyCONDOR/R/data_load_and_transform.R")
source("../../cyCONDOR/R/data_visualization.R")
source("../../cyCONDOR/R/dim_reduction.R")
source("../../cyCONDOR/R/colors.R")
source("../../cyCONDOR/R/clustering.R")
source("../../cyCONDOR/R/misc.R")
```
...
This first part describes the general `cyCONDOR` data processing and dimensionality reduction workflow (see vignettes: `Data loading and transformation` and `Dimensionality Reduction` for more details) until the closer inspection of the data set and identification of a technical batch effect. 
...
condor <- prep_fcd(data_path = "/data/analysis/data/Figure 3 - Batch Correction/data/CureDem/all/",
                   max_cell = 500,
                   useCSV = FALSE,
                   transformation = "auto_logi",
                   remove_param = c("InFile", "Time", "FSC-H", "SSC-H"),
                   anno_table = "/data/analysis/data/Figure 3 - Batch Correction/data/CureDem/all.csv",
                   filename_col = "filename"
)
