...
plot_dim_red(fcd = condor, 
             ...
             add_astir = TRUE, 
             astir_slot = "Astir_cell_type_orig",
             param = "cell_type", 
             order = T, 
             title = "UMAP colored by Astir predicted cell type", 
...
plot_dim_red(fcd = condor, 
             ...
             reduction_slot = "pca_orig", 
             add_astir = TRUE, 
             astir_slot = "Astir_cell_state_orig",
             param = "Naive", 
             order = F, 
             title = "UMAP colored by Astir predicted cell state", 
             facet_by_variable = FALSE, 
             raster = TRUE, 
             alpha = .3, 
             dot_size = 1)
