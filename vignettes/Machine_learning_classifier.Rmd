...
```{r}
condor <- prep_fcd(data_path = "../../../../2_data/paper_figures/Figure 7 - Clinical Classifier/data_and_envs/CytoDX/", 
                   max_cell = 10000000, 
                   useCSV = FALSE, 
                   transformation = "auto_logi", 
                   remove_param = c("FSC-A","FSC-W","FSC-H","Time"), 
                   anno_table = "../../../../2_data/paper_figures/Figure 7 - Clinical Classifier/data_and_envs/CytoDX/fcs_info_train.csv", 
...
```{r}
anno <- read.csv("../../../../2_data/paper_figures/Figure 7 - Clinical Classifier/data_and_envs/CytoDX/fcs_info_train.csv")
...
```{r}
condor_test <- prep_fcd(data_path = "../../../../2_data/paper_figures/Figure 7 - Clinical Classifier/data_and_envs/CytoDX/", 
                        max_cell = 10000000, 
                        useCSV = FALSE, 
                        transformation = "auto_logi", 
                        remove_param = c("FSC-A","FSC-W","FSC-H","Time"), 
                        anno_table = "../../../../2_data/paper_figures/Figure 7 - Clinical Classifier/data_and_envs/CytoDX/fcs_info_test.csv", 
                        filename_col = "fcsName",
                        seed = 91)
```
...
```{r}
anno <- read.csv("../../../../2_data/paper_figures/Figure 7 - Clinical Classifier/data_and_envs/CytoDX/fcs_info_test.csv")
