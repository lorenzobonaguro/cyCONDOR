...
#' @param fcd_model Flow cytometry reference dataset containing data associated with an existing embedding in \code{fcd_model$extras}.
...
#' @param nThreads Number of threads to use, (except during stochastic gradient descent). Default is half the number of concurrent threads supported by the system.
